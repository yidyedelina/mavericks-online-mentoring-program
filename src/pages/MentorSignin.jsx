...
<div className="relative py-3 sm:max-w-xl sm:mx-auto">
  ...
  <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
    <div className="max-w-md mx-auto">
      <div>
        <h1 className="text-2xl font-semibold">Mentor Signin</h1>
      </div>
      <div className="divide-y divide-gray-200">
        <form action="#" method="POST" className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
          ...
          <div className="flex justify-end">
            <button type="submit" className="bg-gradient-to-r from-cyan-400 to-light-blue-500 text-white font-semibold px-6 py-2 rounded-full">Signin</button>
          </div>
        </form>
